(function(){
    angular.module("EventBus", []).factory('EventBus', ["$injector", "$rootScope", function ($injector) {
        return function() { return $injector.instantiate(EventBus); };
    }]);
    ...
    function EventBus(){
        ...
        this.hasEventListeners = function(eventName){
            var eventNameParts = eventName.split("."),
                eventType = eventNameParts[0],
                namespaceName = eventNameParts[1];
